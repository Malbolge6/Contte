  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm fade-in">
        ...
        >
          <h2 style={{ fontSize: '20px', fontWeight: 700, marginBottom: '6px', color: '#f8f9fa' }}>
            Bem-vindo de volta
          </h2>
          <p style={{ color: '#6b6b80', fontSize: '14px', marginBottom: '24px' }}>
            Entre na sua conta
          </p>
        ...
        <p style={{ textAlign: 'center', marginTop: '20px', color: '#6b6b80', fontSize: '14px' }}>
          Não tem conta?{' '}
          <Link href="/register" style={{ color: '#ccff00', fontWeight: 600, textDecoration: 'none' }}>
            Criar conta
          </Link>
        </p>
      </div>
